 ...
 */
public abstract class HokFragmentActivity extends FragmentActivity{

    private String LOG_TAG="HokFragmentActivity";
    public static boolean DEBUG = true;
    protected HokFragment mCurrentFragment;
    ...
    private void goToThisFragment(FragmentParam param) {
        ...
        try {
            ...
            HokFragment fragment = (HokFragment) fm.findFragmentByTag(fragmentTag);
            if (fragment == null) {
                fragment = (HokFragment) cls.newInstance();
            }
    ...
    public void goToFragment(Class<?> cls, Object data) {
        ...
        HokFragment fragment = (HokFragment) getSupportFragmentManager().findFragmentByTag(cls.toString());
        if (fragment != null) {
            mCurrentFragment = fragment;
    ...
    private boolean tryToUpdateCurrentAfterPop() {
        ...
        if (cnt > 0) {
            ...
            if (fragment != null && fragment instanceof HokFragment) {
                mCurrentFragment = (HokFragment) fragment;
            }
            return true;
        }
        return false;
