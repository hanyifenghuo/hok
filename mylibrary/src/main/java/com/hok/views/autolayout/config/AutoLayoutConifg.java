package com.hok.views.autolayout.config;

import android.content.Context;
import android.content.pm.ApplicationInfo;
import android.content.pm.PackageManager;

import com.hok.views.autolayout.utils.L;
import com.hok.views.autolayout.utils.ScreenUtils;
...
public class AutoLayoutConifg
{
    ...
    public void setDesignSize(int mWidth,int mHeight)
    {
        this.mDesignWidth=mWidth;
        this.mDesignHeight=mHeight;
    }
