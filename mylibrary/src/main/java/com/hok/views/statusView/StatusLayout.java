...
public class StatusLayout {
    ...
    public StatusLayout(Context context, View targetView) {
    ...
    public StatusLayout(Context context, int viewID) {
        this.mContext = context;
        this.mInflater = ((Activity) mContext).getLayoutInflater();
    ...
    public void setEmptyMessage(String message) {
        ((TextView) mDefaultViews.get(3).findViewById(R.id.exception_message)).setText(message);
    }
    ...
    public void setEmptyTitle(String message) {
