...
public class IOSAlertDialog {
	...
	public IOSAlertDialog builder() {
		...
		View view = LayoutInflater.from(context).inflate(
				R.layout.dialog_ios_alertdialog, null);
		// 获取自定义Dialog布局中的控件
	...
	private void setLayout() {
		...
		if (!showPosBtn && !showNegBtn) {
			...
			btn_pos.setBackgroundResource(R.drawable.dialog_ios_alertdialog_single_selector);
			btn_pos.setOnClickListener(new OnClickListener() {
				@Override
				public void onClick(View v) {
					dialog.dismiss();
		...
		if (showPosBtn && showNegBtn) {
			btn_pos.setVisibility(View.VISIBLE);
			btn_pos.setBackgroundResource(R.drawable.dialog_ios_alertdialog_right_selector);
			btn_neg.setVisibility(View.VISIBLE);
			btn_neg.setBackgroundResource(R.drawable.dialog_ios_alertdialog_left_selector);
		...
		if (!showPosBtn && showNegBtn) {
			btn_neg.setVisibility(View.VISIBLE);
			btn_neg.setBackgroundResource(R.drawable.dialog_ios_alertdialog_single_selector);
		}
	}
